  ...
  return (
    <div className="min-h-screen bg-brand-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-brand-card border border-brand-border rounded-2xl p-8 shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-white mb-6 text-center">Join the Movement</h2>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          Already have an account? <Link to="/login" className="text-neon-green hover:underline font-bold">Login</Link>
        </div>
      </div>
    </div>
  );
